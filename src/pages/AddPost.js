...
<meta name="twitter:creator" content="@the-recipes-food"/>
            ...
            <h3>text</h3>
            {/* <textarea placeholder="text" value={text} onChange={(e) => setText(e.target.value)} style={{ minHeight: '400px' }}/> */}
            ...
            <hr style={{ height: 1, backgroundColor: '#101010', width: '80%', margin: '40px auto 10px auto' }}/>
                ...
                /><p>tsen xwia ...</p></> : <></>}
            <button onClick={() => {
                if(title&&stars&&views&&happy&&sad&&comments&&imgData && pages.length >=1) {
                    upload()
                } else {
                    alert('3amar 3amar !!')
                }
