...
function Contact() {
    return (
      <div className="_3OKkVt3YsYyhEVJMRc3E1H">
      <Helmet>
          <title>Contact us - The recipes food</title>
          <meta
            name="description"
...
<meta name="twitter:creator" content="@the-recipes-food"/>
        ...
        <main className><div className="_2Fzs-4C9-slDjSLKsA2rmt _2S1V3DImgIJjd0eZEBqQd4 _3DW1b-i7BQOF5UjCiEN3xg"><div className="_2B_GF9HBceNougfSikJqQc"><h1>Contact us</h1>
        <p>
          Your name
        </p>
