...
function Page404() {
    return (
        <div className="css-bh18vsdc">
        <Helmet>
            <title>The recipes food - Error 404</title>
            <meta
              name="description"
              content="he recipes food, Error 404, Sorry, this page isn't available"
            />
            ...
            <div className="css-bh18vc">
                <div className="css-4p9r15">
                    <div>
                        <h1 className="css-19bg7qi">Sorry, this page isn't available.</h1>
                    ...
                    <div className="css-4p9r15">
                        <Link className="css-132u05m" to="/">Go to homepage</Link>
                    </div>
                </div>
            </div>
        </div>
